...
if job_title and company:
    context_str = f"Contact works as {job_title} at {company}."
elif job_title:
    context_str = f"Contact works as {job_title}."
else:
    context_str = f"Contact works at {company}."
...
3. ORIGINALITY     - Does it avoid generic/cliche phrases?
